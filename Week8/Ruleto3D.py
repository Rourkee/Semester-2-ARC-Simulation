...
# Synonyms normalization (mirror transformation.py)
_SYNONYMS = {
...
if __name__ == "__main__":
    ...
    # Translation tests
    res2 = execute_rule(scene, "translate(1,2)", (4,5))
    assert res2["A"] == {"row": 1, "col": 2}
    assert res2["B"] == {"row": 3, "col": 3}
    assert translation_hint_cells("translate_-2_3") == (-2, 3)
